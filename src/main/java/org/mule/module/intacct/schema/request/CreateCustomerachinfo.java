...
@XmlType(name = "create_customerachinfoType", propOrder = {"customerid", "bankname", "bankadd1", "bankadd2", "aba", "accountnumber",
    "bankaccounttype"})
@XmlRootElement(name = "create_customerachinfo")
public class CreateCustomerachinfo
{
