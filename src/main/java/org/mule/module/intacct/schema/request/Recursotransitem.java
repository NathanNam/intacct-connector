...
@XmlType(name = "", propOrder = {"itemid", "itemdesc", "warehouseid", "quantity", "unit", "price",
    "discsurchargememo", "locationid", "departmentid", "memo", "itemdetails", "customfields",
    "revrectemplate", "revrecstartdate", "revrecenddate", "status", "projectid", "customerid", "vendorid",
    "employeeid", "classid"})
@XmlRootElement(name = "recursotransitem")
public class Recursotransitem
{
