...
public class Moduleprefs
{
    ...
    /**
     * Gets the value of the modulepref property.
     * <p>
     * This accessor method returns a reference to the live list, not a snapshot.
     * Therefore any modification you make to the returned list will be present
     * inside the JAXB object. This is why there is not a <CODE>set</CODE> method for
     * the modulepref property.
     * <p>
     * For example, to add a new item, do as follows:
     * 
     * <pre>
     * getModulepref().add(newItem);
     * </pre>
     * <p>
     * Objects of the following type(s) are allowed in the list {@link Modulepref }
     */
    public List<Modulepref> getModulepref()
    {
        if (modulepref == null)
        {
            modulepref = new ArrayList<Modulepref>();
        }
