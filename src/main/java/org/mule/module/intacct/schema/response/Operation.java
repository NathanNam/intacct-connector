...
@XmlType(name = "", propOrder = {"authentication", "errormessageOrResult"})
...
public class Operation
{
    ...
    {
        if (errormessageOrResult == null)
        {
            errormessageOrResult = new ArrayList<Object>();
        }
        return this.errormessageOrResult;
    }
