...
@XmlType(name = "", propOrder = {"subtotal"})
@XmlRootElement(name = "subtotals")
public class Subtotals
{

    protected List<Subtotal> subtotal;
     ...
     * </pre>
     * <p>
     * Objects of the following type(s) are allowed in the list {@link Subtotal }
     */
    public List<Subtotal> getSubtotal()
    {
        if (subtotal == null)
        {
            subtotal = new ArrayList<Subtotal>();
        }
