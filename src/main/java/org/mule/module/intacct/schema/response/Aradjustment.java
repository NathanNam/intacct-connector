...
@XmlType(name = "", propOrder = {"key", "customerid", "datecreated", "dateposted", "datepaid", "batchkey",
    "adjustmentno", "invoiceno", "description", "totalamount", "totalpaid", "totaldue", "totalselected",
    "whenmodified", "state", "basecurr", "currency", "trxTotalamount", "trxTotalpaid", "trxTotaldue",
    "trxTotalselected", "aradjustmentitems"})
@XmlRootElement(name = "aradjustment")
