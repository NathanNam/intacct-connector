...
@XmlType(name = "", propOrder = {"accountlabelOrGlaccountno", "form1099", "amount", "memo", "locationid",
    "departmentid", "projectid", "customerid", "vendorid", "employeeid", "itemid", "classid", "billable"})
