...
@XmlType(name = "", propOrder = {"itemid", "itemdesc", "taxable", "warehouseid", "quantity", "unit", "price",
    "locationid", "departmentid", "memo", "itemdetails", "customfields", "projectid", "customerid",
    "vendorid", "employeeid", "classid", "billable"})
@XmlRootElement(name = "updatepotransitem")
public class Updatepotransitem
{
