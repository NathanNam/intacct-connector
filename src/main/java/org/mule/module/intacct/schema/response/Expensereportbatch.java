...
@XmlType(name = "", propOrder = {"key", "batchtitle", "datecreated", "open", "status", "totalamount",
    "expensereport"})
@XmlRootElement(name = "expensereportbatch")
public class Expensereportbatch
{
    ...
    protected List<Expensereport> expensereport;
     ...
     * </pre>
     * <p>
     * Objects of the following type(s) are allowed in the list {@link Expensereport }
     */
    public List<Expensereport> getExpensereport()
    {
        if (expensereport == null)
        {
            expensereport = new ArrayList<Expensereport>();
        }
