...
@XmlType(name = "create_araccountlabelType", propOrder = {"glaccountno", "accountlabel", "description", "offsetglaccountno", "status",
    "externalid", "taxcode"})
@XmlRootElement(name = "create_araccountlabel")
public class CreateAraccountlabel
{
