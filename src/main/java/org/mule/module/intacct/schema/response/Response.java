...
@XmlType(name = "", propOrder = {"control", "operationOrErrormessage"})
...
public class Response
{
     ...
     * 
     * @param value allowed object is {@link Control }
     */
    ...
    /**
     * Gets the value of the operationOrErrormessage property.
     * <p>
     * This accessor method returns a reference to the live list, not a snapshot.
     * Therefore any modification you make to the returned list will be present
     * inside the JAXB object. This is why there is not a <CODE>set</CODE> method for
     * the operationOrErrormessage property.
     * <p>
     * For example, to add a new item, do as follows:
     * 
     * <pre>
     * getOperationOrErrormessage().add(newItem);
     * </pre>
     * <p>
    ...
    {
        if (operationOrErrormessage == null)
        {
            operationOrErrormessage = new ArrayList<Object>();
        }
        return this.operationOrErrormessage;
    }
