...
@XmlType(name = "", propOrder = {"key", "batchtitle", "datecreated", "open", "status", "totalamount", "bill"})
@XmlRootElement(name = "billbatch")
public class Billbatch
{
     ...
     * </pre>
     * <p>
     * Objects of the following type(s) are allowed in the list {@link Bill }
     */
