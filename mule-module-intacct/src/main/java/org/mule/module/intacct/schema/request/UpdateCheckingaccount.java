...
@XmlType(name = "update_checkingaccountType", propOrder = {"bankaccountno", "locationid", "bankname", "routingno", "branchid", "phone",
    "currency", "mailaddress", "status", "disableiet", "financialdata",
    "servicechargeglaccountOrServicechargeaccountlabel",
    "interestearnedglaccountOrInterestearnedaccountlabel", "departmentid", "checkinfocontact", "checklayout",
    "nextcheck"})
@XmlRootElement(name = "update_checkingaccount")
public class UpdateCheckingaccount
{

    @XmlAttribute(name = "bankaccountid", required = true)
    ...
    /**
     * Gets the value of the checkinfocontact property.
     * 
     * @return possible object is {@link Checkinfocontact }
     */
    public Checkinfocontact getCheckinfocontact()
    {
        return checkinfocontact;
    }

    /**
     * Sets the value of the checkinfocontact property.
     * 
     * @param value allowed object is {@link Checkinfocontact }
     */
    public void setCheckinfocontact(Checkinfocontact value)
    {
        this.checkinfocontact = value;
    }

    /**
     * Gets the value of the checklayout property.
     * 
     * @return possible object is {@link Checklayout }
     */
     ...
     * 
     * @param value allowed object is {@link Checklayout }
     */
    public void setChecklayout(Checklayout value)
    {
