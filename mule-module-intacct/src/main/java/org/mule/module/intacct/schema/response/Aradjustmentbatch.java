...
public class Aradjustmentbatch
{
    ...
    /**
     * Gets the value of the aradjustment property.
     * <p>
     * This accessor method returns a reference to the live list, not a snapshot.
     * Therefore any modification you make to the returned list will be present
     * inside the JAXB object. This is why there is not a <CODE>set</CODE> method for
     * the aradjustment property.
     * <p>
     * For example, to add a new item, do as follows:
     * 
     * <pre>
     * getAradjustment().add(newItem);
     * </pre>
     * <p>
     * Objects of the following type(s) are allowed in the list {@link Aradjustment }
     */
    public List<Aradjustment> getAradjustment()
    {
        if (aradjustment == null)
        {
            aradjustment = new ArrayList<Aradjustment>();
        }
